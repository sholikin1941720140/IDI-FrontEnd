    ...
    return (
        ...
        <Sidebar />
            <div class="p-4 sm:ml-64">
                <div class="h-full p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14">
                        ...
                        <div class="max-w-full h-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="justify-start w-full h-full mt-4">
                                ...
                                <div class="mx-auto max-w-sm justify-center mt-10">
                                    ...
                                    <div className="py-4">
                                        <p class="text-center ...">Ups, <strong className="text-primary-600">Data Pribadimu</strong> Masih Kosong</p>
                                    </div>
