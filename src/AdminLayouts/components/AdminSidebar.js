        ...
        <>
            <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
                <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
                    ...
                    {/* Brand */}
                    <a href="#" class="flex md:mr-24 -ml-2 mt-2">
                        <img src="/Asset/logoidi.png" class="h-8 mr-3" alt="FlowBite Logo" />
                        <span class="self-center text-sm font-bold text-primary-800 sm:text-sm whitespace-nowrap dark:text-white uppercase">Admin IDI Malang Raya</span>
                    </a>
                    {/* <Link
                            ...
                            <li className="items-center flex">
                                ...
                                <Link
                                    className={
                                        ...
                                        (window.location.href.indexOf("/master-data-anggota") !== -1
                                            ? "text-primary-700 hover:text-primary-600"
                                            : "text-blueGray-700 hover:text-blueGray-500")
                                    }
                                    to="/master-data-anggota"
                                >
                                    <i
                                        className={
